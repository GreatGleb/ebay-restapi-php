...
class UpdateProductsFromDbToGoogleSheets:
    ...
    def filter_updating_columns(self, products_db_data):
        allowed_props = {'#', 'Reference', 'TecDoc number', 'Supplier price without VAT', 'Supplier price with VAT', 'Retail price without VAT', 'Retail price with VAT', 'Quantity PL', 'Quantity Pruszkow', 'Link', 'Name original pl', 'Category eBay.de Russian', 'Installation position Russian',  'Installation position English',  'Installation position German', 'Specifics Russian', 'Specifics English', 'Specifics German', 'Product type Russian', 'Product type English', 'Product type German', 'Description to eBay.de', 'Specifics to eBay.de', 'Category id eBay.de', 'Photo links', 'Photo', 'No photo', 'EAN', 'weight gram', 'Producer brand', 'Oe codes', 'Car compatibilities', 'Published to eBay.de?', 'Last update to eBay.de', 'eBay.de similar products names', 'eBay.de similar products photo', 'Supplier', 'Part of eBay name - for cars', 'Part of eBay.de name - product type', 'eBay name German'}#'Part of eBay.de name - product type', 'Part of eBay name - for cars', 'eBay name Russian', 'eBay name English', 'eBay name German',
